        ...
        <section className="relative bg-gradient-to-br from-primary-50 to-blue-100 dark:from-dark-800 dark:to-dark-900 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Hi, I'm <span className="text-primary-600 dark:text-primary-400">Kamran</span>
            </h1>
        ...
        <section className="py-20 bg-white dark:bg-dark-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="section-subtitle text-center">
              I love creating innovative solutions and sharing knowledge through writing and collaboration.
            </p>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-primary-100 to-blue-200 dark:from-primary-900/30 dark:to-blue-900/30 rounded-2xl p-8">
                <div className="aspect-square bg-white dark:bg-dark-800 rounded-xl shadow-lg flex items-center justify-center">
                  <span className="text-6xl text-primary-600 dark:text-primary-400">👨‍💻</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="card text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Writing & Blogging</h3>
                <p className="text-gray-600 dark:text-gray-300">
              ...
              <div className="card text-center">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Working with teams to bring innovative ideas to life.
                </p>
              </div>
            </div>
          </div>
